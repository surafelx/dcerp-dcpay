...
exports.createPeriodTransaction = exports.createPayTransaction = void 0;
const pool_1 = __importDefault(require("../config/pool"));
const uuid_1 = require("uuid");
const createPayTransaction = async (newMenu, periodId) => {
...
const updateCurrentPeriod = async (organizationId, periodId, userId) => {
   ...
   WHERE pts.organization_id=$1 AND pts.period_id=$2`, [organizationId, periodId]);
    for (const pt of periodTransactions) {
        try {
            if (pt.permanent) {
                const createdPayTransaction = await (0, exports.createPayTransaction)({ organizationId, employeeId: pt.employee_id, transactionId: pt.transaction_id, transactionAmount: pt.transaction_amount }, openedPeriod[0].id);
...
//# sourceMappingURL=periodClosing.js.map
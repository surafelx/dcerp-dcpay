...
const EnhancedTable = ({ rows, page, setAlertText, setPage, branches, formData, setFormData, reset, setBranchObject, deleteDepartment, storeProcess, handleClickOpen }: any) => {
    // ** States

...
export const generateExcelFile = (store: any) => {
    ...
    store.data.filter(({ employeeStatusName }: any) => employeeStatusName == 'Active').forEach(({ employeeCode, employeeName, transactions, employeeDepartment, monthlyWorkingHours }: any, index: any) => {
        ...
        const hardship20 = transactions?.find((obj: any) => obj.transaction_name === "Hardship Allowance 20%") || { transaction_amount: 0 };
        const hardship15 = transactions?.find((obj: any) => obj.transaction_name === "Hardship Allowance 15%") || { transaction_amount: 0 };

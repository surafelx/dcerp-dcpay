...
const defaultTransactions = [
    ...
    {
        transactionCode: '101',
        transactionName: 'East Oromo',
        shortName: 'East Oromo',
        transactionType: 'NA',
        updateType: 'Input',
        permanent: true,
        taxable: true,
    ...
    {
        transactionCode: '106',
        transactionName: 'Project -Church Relation',
        shortName: 'Project -Church Relation',
        transactionType: 'NA',
        updateType: 'Input',
        permanent: true,
        taxable: true,
    ...
    {
        transactionCode: '107',
        transactionName: 'Membership Office',
        shortName: 'Membership Office',
        transactionType: 'NA',
        updateType: 'Input',
        permanent: true,
        taxable: true,
    ...
    {
        transactionCode: '108',
        transactionName: 'Good samaritan-Norway',
        shortName: 'Good samaritan-Norway',
        transactionType: 'NA',
        updateType: 'Input',
        permanent: true,
        taxable: true,
    ...
    {
        transactionCode: '109',
        transactionName: 'Pension Branch',
        shortName: 'Pension Branch',
        transactionType: 'NA',
        updateType: 'Input',
        permanent: true,
        taxable: true,
    ...
    {
        transactionCode: '110',
        transactionName: 'East Oromo German',
        shortName: 'East Oromo German',
        transactionType: 'NA',
        updateType: 'Input',
        permanent: true,
        taxable: true,
